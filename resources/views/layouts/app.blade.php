...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('/plugins/select2-bootstrap4-theme/select2-bootstrap4.css/select2-bootstrap4.min.css') }}">
    @yield('style')
</head>
    ...
    <div class="wrapper">
            ...
            <div class="p-3">
                <ul class="navbar-nav ms-auto">
                    ...
                    @else
                        ...
                        <li>
                            <a class="text-white text-sm" href="{{ route('logout') }}" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="16" fill="white">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy;
                ...
                <a href="#">Restaurant Order System</a>.
